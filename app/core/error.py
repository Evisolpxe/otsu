...
class ResCode:
    ...
    RES_CODE = {
        ...
        11102: '已将图池(MappoolStage)加入到比赛当中！',
        12102: '图池(MappoolStage)已经存在啦！',

        32101: '没有找到这个比赛(Tourney)哦！',
        # ==========
        ...
        32303: '没有查询到相应评价。',
        32304: '没有查询到相应评论。',
        32305: '没有找到对应图池的Stage哦。',

        41301: '删除图池成功！',
        41302: '删除谱面成功！下次再来噢~',
        41303: '删除评价成功！下次再来噢~',
        41304: '删除评论成功！下次再来噢~',
        41305: '删除Stage成功！下次再来噢~',
        ...
        32201: '这场对局(Match)已经被上传过咯！',
        33201: '没有找到这场对局(Match)！',
        34201: '没有在官网找到这场对局(Match)！',

        31211: '成功添加这场对局(Match)至比赛(Tourney)!',
        31221: '成功添加这场对局(Match)至图池(MappoolStage)!',
        32211: '没有在本场对局(Match)中找到可用的图池(MappoolStage)！',
