...
app.include_router(router.users.router, tags=['User'], prefix='/user')
app.include_router(router.maps.router, tags=['Map'], prefix='/map')
app.include_router(router.ewc.router, tags=['EWC'], prefix='/ewc')
